...
class CouponController extends Controller
{
    ...
    {
        // Retrieve influencers only (where role is 'influencer')
        $influencers = User::where('role', 'influencer')->get();
        return view('backend.coupon.create', compact('influencers'));
    }
    ...
    public function edit($id)
    {
        ...
        if ($coupon) {
            return view('backend.coupon.edit', compact('coupon', 'influencers'));
        } else {
