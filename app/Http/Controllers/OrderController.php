...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->payment_method == 'bank_transfer') {
            // Save order details to database for bank transfer
            // Handle bank transfer specific logic here
            ...
            // }
            if ($request->payment_method == 'paypal' || $request->payment_method == 'cardpay' || $request->payment_method == 'flutterwave') {
        ...
        if ($request->payment_method == 'paystack') {
            ...
            // Payment processing logic will be handled in the redirectToGateway method
            // return $this->redirectToGateway($request);
            return app()->make(PaystackController::class)->redirectToGateway($request);
        }

        // Handle Flutterwave payment
        if ($request->payment_method == 'flutterwave') {
            // Redirect to Flutterwave gateway
            // Payment processing logic will be handled in a similar method as Paystack
        }
    }
