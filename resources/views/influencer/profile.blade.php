                ...
                <div class="col-md-8">
                    <form class="border px-4 pt-2 pb-3" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputTitle" type="tel" name="phone" placeholder="Enter phone number"
                        ...
                        <div class="form-group">
                            <label for="inputTitle" class="col-form-label">Bank</label>
                            <input id="inputTitle" type="text" name="bank" placeholder="Enter Bank"
                                value="{{ $profile->bank }}" class="form-control">
                            @error('bank')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input id="inputTitle" type="text" name="account_number" placeholder="Enter Account Number"
